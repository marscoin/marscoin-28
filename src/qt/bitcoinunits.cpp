...
{
    switch (unit) {
    case Unit::BTC: return QString("MARS");
    case Unit::mBTC: return QString("mMARS");
    case Unit::uBTC: return QString::fromUtf8("µMARS (bits)");
    case Unit::SAT: return QString("Marsoshi (sat)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Marscoins");
    case Unit::mBTC: return QString("Milli-Marscoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Marscoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    case Unit::SAT: return QString("Marsoshi (sat) (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
